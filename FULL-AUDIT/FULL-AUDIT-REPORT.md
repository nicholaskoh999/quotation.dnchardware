...
**4,822 assertions, 8 failed, 0 skipped** — the eight are the recorded
...
**TOTAL ASSERTIONS 4,822 · TOTAL FAILED 8 · SKIPPED 0.**
...
**Twenty files, twenty claims.** The per-suite logs are slices of the single
...
recorded environment exception and 3,928 pass; 4,822 across everything.
